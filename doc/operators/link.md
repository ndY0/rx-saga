...
the link operator allow you to chain a command to another, while specifying the error propagation

```typescript
import SagaSubject from "rx-saga";
import { link } from "rx-saga/operators";
 ...
 */
const linkedSaga = saga.pipe(link(map, liftError, mapError, mapResponse, mapErrorResponse))
...
<img src="../assets/linkoperator.drawio.svg">